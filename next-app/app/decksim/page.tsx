  ...
  return (
    <>
      ...
      <div className="container mx-auto mb-6 px-2 md:px-6 lg:max-w-screen-lg">
        ...
        <div className="my-4 md:pl-4 max-w-screen-sm space-y-4 leading-7">
          <div>
            ...
            <div className="space-y-4 md:px-4">
              <div className="pl-4 relative before:w-2 before:h-2 before:rounded-full before:bg-secondary before:inline-block before:absolute before:left-0 before:top-3">
                <p>
                  フレンドぷちガールちゃん レアリティUR の 応援力効果 Lv.22
                  の数値についての情報を募集しています。
                  <br />
                  もし実際のゲーム内での表示値が本サイトの
                  <Link
                    href="/decksim/parameters/#petitGirlsEffects"
                    className="link mx-2"
                  >
                    設定値のページ
                  </Link>
                  に記載の数値と異なる場合はご連絡いただけたら幸いです。
                  一部を推定値で設定しているため、実際と異なる場合は計算結果に誤差が発生しています。
                </p>
              </div>
              ...
              <div className="pl-4 relative before:w-2 before:h-2 before:rounded-full before:bg-secondary before:inline-block before:absolute before:left-0 before:top-3">
                ...
                <div className="mt-2 md:pl-4">
                  ...
                  <p className="pl-4 relative before:w-2 before:h-2 before:rounded-full before:bg-accent before:inline-block before:absolute before:left-0 before:top-[12px]">
                    <span>
                      [至福の時間]村上文緒 (COOLガールのコストが高いほど攻守UP)
                    </span>
                  </p>
                  <p className="pl-4 relative before:w-2 before:h-2 before:rounded-full before:bg-accent before:inline-block before:absolute before:left-0 before:top-[12px]">
                    <span>
                      [居留守失敗]篠宮りさ (POPガールのコストが高いほど攻守UP)
                    </span>
                  </p>
                  <span className="pl-4">
