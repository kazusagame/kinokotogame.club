...
import { RaidFirstSpecialManual } from "@/features/decksim/components/manual/eventSpecial/raid-first";
import { RaidSecondSpecialManual } from "@/features/decksim/components/manual/eventSpecial/raid-second";
import { RaidMegaSpecialManual } from "@/features/decksim/components/manual/eventSpecial/raid-mega";
import { RaidwarSpecialManual } from "@/features/decksim/components/manual/eventSpecial/raidwar";
import { ClubcupSpecialManual } from "@/features/decksim/components/manual/eventSpecial/clubcup";
import { ChampionshipSpecialManual } from "@/features/decksim/components/manual/eventSpecial/championship";
import { DivraceSpecialManual } from "@/features/decksim/components/manual/eventSpecial/divrace";
import { BoardSpecialManual } from "@/features/decksim/components/manual/eventSpecial/board";
import { NormalBattleSpecialManual } from "@/features/decksim/components/manual/eventSpecial/normal-battle";
...
export function DeckSimulatorHowToUse({
  ...
  return (
    <div className="flex flex-col gap-4 my-2 px-2 md:px-4 leading-loose sm:max-w-screen-sm">
      ...
      {eventId === "divrace" && <DivraceSpecialManual />}
