...
export const BOARD_WEATHER_DATA: { [K: number]: BoardWeather } = {
  ...
  3: {
    ...
    effectList: [
      ...
      { name: "コスト26以上ガールの攻援力", effectType: "ガール", effectValue: 30, condition: { cost: 26 } },
  ...
  4: {
    name: "晴れ(30℃)",
    effectList: [
      { name: "声援Lv.12以上かつコスト25以上ガールの攻援力", effectType: "ガール", effectValue: 30, condition: { skillLv: 12, cost: 25 } },
      { name: "SP応援効果", effectType: "SP応援効果", effectValue: 20, condition: {} },
