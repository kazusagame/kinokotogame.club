...
export type RowDataBoardRewardRound202606 = {
  rank: string;
  reward_1: number;
  reward_2: number;
  reward_3: number;
...
const columnHelper = createColumnHelper<RowDataBoardRewardRound202606>();
export const columnDefBoardRewardRound202606 = [
