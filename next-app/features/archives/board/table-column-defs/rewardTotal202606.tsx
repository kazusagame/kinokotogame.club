...
export type RowDataBoardRewardTotal202606 = {
  rank: string;
  reward_1: number;
  reward_2: number;
  reward_3: number;
...
const columnHelper = createColumnHelper<RowDataBoardRewardTotal202606>();
export const columnDefBoardRewardTotal202606 = [
  ...
  columnHelper.accessor("reward_1", {
    ...
    sortingFn: "basic",
    meta: {
      label: "[モデル体験26]川上瀬莉(SR)",
      textAlign: "center",
    },
  }),
  columnHelper.accessor("reward_2", {
    header: "[清らかに]皆藤蜜子用マカロン",
    cell: (info) => {
      return info.getValue().toLocaleString("ja-JP", {
        style: "decimal",
        useGrouping: true,
