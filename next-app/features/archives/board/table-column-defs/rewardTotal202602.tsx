...
export type RowDataBoardRewardTotal202602 = {
  rank: string;
  reward_1: number;
  reward_2: number;
  reward_3: number;
...
const columnHelper = createColumnHelper<RowDataBoardRewardTotal202602>();
export const columnDefBoardRewardTotal202602 = [
  ...
  columnHelper.accessor("reward_1", {
    ...
    sortingFn: "basic",
    meta: {
      label: "[ｼｮｰﾄﾍｱ26]鈴河凜乃(SR)",
      textAlign: "center",
    },
  }),
  columnHelper.accessor("reward_2", {
    header: "[ﾁｱﾌﾙﾁｪﾝｼﾞ!]新垣雛菜用マカロン",
    cell: (info) => {
      return info.getValue().toLocaleString("ja-JP", {
        style: "decimal",
        useGrouping: true,
