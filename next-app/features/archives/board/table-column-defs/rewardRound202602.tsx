...
export type RowDataBoardRewardRound202602 = {
  rank: string;
  reward_1: number;
  reward_2: number;
  reward_3: number;
...
const columnHelper = createColumnHelper<RowDataBoardRewardRound202602>();
export const columnDefBoardRewardRound202602 = [
