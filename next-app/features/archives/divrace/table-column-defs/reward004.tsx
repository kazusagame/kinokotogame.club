...
export type RowDataDivraceReward004 = {
  class: string;
  grade: string;
  rank: string;
  reward_1: number;
...
const columnHelper = createColumnHelper<RowDataDivraceReward004>();
export const columnDefDivraceReward004 = [
  ...
  columnHelper.accessor("reward_3", {
    header: "NewSR音羽ユリ用マカロン",
    cell: (info) => info.getValue(),
    sortingFn: "basic",
    meta: {
      label: "NewSR音羽ユリ用マカロン",
      textAlign: "center",
    },
  }),
