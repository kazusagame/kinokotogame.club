...
export type RowDataDivraceReward006 = {
  class: string;
  grade: string;
  rank: string;
  reward_1: number;
...
const columnHelper = createColumnHelper<RowDataDivraceReward006>();
export const columnDefDivraceReward006 = [
  ...
  columnHelper.accessor("reward_3", {
    header: "NewSR藤堂静子用マカロン",
    cell: (info) => info.getValue(),
    sortingFn: "basic",
    meta: {
      label: "NewSR藤堂静子用マカロン",
      textAlign: "center",
    },
  }),
