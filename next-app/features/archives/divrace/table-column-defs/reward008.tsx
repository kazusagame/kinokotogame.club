...
export type RowDataDivraceReward008 = {
  class: string;
  grade: string;
  rank: string;
  reward_1: number;
...
const columnHelper = createColumnHelper<RowDataDivraceReward008>();
export const columnDefDivraceReward008 = [
  ...
  columnHelper.accessor("reward_3", {
    header: "NewSR大山真由里用マカロン",
    cell: (info) => info.getValue(),
    sortingFn: "basic",
    meta: {
      label: "NewSR大山真由里用マカロン",
      textAlign: "center",
    },
  }),
