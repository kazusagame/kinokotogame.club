...
export type RowDataDivraceReward005 = {
  class: string;
  grade: string;
  rank: string;
  reward_1: number;
...
const columnHelper = createColumnHelper<RowDataDivraceReward005>();
export const columnDefDivraceReward005 = [
  ...
  columnHelper.accessor("reward_3", {
    header: "NewSR鍋島ちより用マカロン",
    cell: (info) => info.getValue(),
    sortingFn: "basic",
    meta: {
      label: "NewSR鍋島ちより用マカロン",
      textAlign: "center",
    },
  }),
