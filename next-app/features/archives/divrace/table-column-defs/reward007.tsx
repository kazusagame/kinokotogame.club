...
export type RowDataDivraceReward007 = {
  class: string;
  grade: string;
  rank: string;
  reward_1: number;
...
const columnHelper = createColumnHelper<RowDataDivraceReward007>();
export const columnDefDivraceReward007 = [
  ...
  columnHelper.accessor("reward_3", {
    header: "NewSR山野こだま用マカロン",
    cell: (info) => info.getValue(),
    sortingFn: "basic",
    meta: {
      label: "NewSR山野こだま用マカロン",
      textAlign: "center",
    },
  }),
