...
export type RowDataDivraceReward001 = {
  class: string;
  grade: string;
  rank: string;
  reward_1: number;
...
const columnHelper = createColumnHelper<RowDataDivraceReward001>();
export const columnDefDivraceReward001 = [
  ...
  columnHelper.accessor("reward_3", {
    header: "NewSR大山真由里専用マカロン",
    cell: (info) => info.getValue(),
    sortingFn: "basic",
    meta: {
      label: "NewSR大山真由里専用マカロン",
      textAlign: "center",
    },
  }),
