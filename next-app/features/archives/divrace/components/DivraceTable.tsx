...
import {
  RowDataDivraceReward006,
  columnDefDivraceReward006,
} from "@/features/archives/divrace/table-column-defs/reward006";
import {
  RowDataDivraceReward007,
  columnDefDivraceReward007,
} from "@/features/archives/divrace/table-column-defs/reward007";
import {
  RowDataDivraceReward008,
  columnDefDivraceReward008,
} from "@/features/archives/divrace/table-column-defs/reward008";
import {
  RowDataDivracePoint,
...
export default function DivraceTable(props: Props) {
  switch (props.tableType) {
    ...
    case "divraceReward006":
      return (
        <GenericCollapseTable<RowDataDivraceReward006>
          {...props}
          columnDef={columnDefDivraceReward006}
        />
      );
    case "divraceReward007":
      return (
        <GenericCollapseTable<RowDataDivraceReward007>
          {...props}
          columnDef={columnDefDivraceReward007}
        />
      );
    case "divraceReward008":
      return (
        <GenericCollapseTable<RowDataDivraceReward008>
          {...props}
          columnDef={columnDefDivraceReward008}
        />
      );
    case "divracePoint":
      return (
