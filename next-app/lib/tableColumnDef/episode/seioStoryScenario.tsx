...
export type RowDataEpisodeSeioStoryScenario = {
  Volume: string;
  Link: string;
  Chapter: string;
  Theme: string;
...
const columnHelper = createColumnHelper<RowDataEpisodeSeioStoryScenario>();
export const columnDefEpisodeSeioStoryScenario = [
