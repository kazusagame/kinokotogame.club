...
export type RowDataDivraceReward002 = {
  class: string;
  grade: string;
  rank: string;
  reward_1: number;
...
const columnHelper = createColumnHelper<RowDataDivraceReward002>();
export const columnDefDivraceReward002 = [
  ...
  columnHelper.accessor("reward_3", {
    header: "NewSR栢嶋乙女専用マカロン",
    cell: (info) => info.getValue(),
    sortingFn: "basic",
    meta: {
      label: "NewSR栢嶋乙女専用マカロン",
      textAlign: "center",
    },
  }),
