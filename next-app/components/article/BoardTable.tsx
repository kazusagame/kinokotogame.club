...
} from "@/lib/tableColumnDef/board/rewardTotal202405";
import {
  RowDataBoardRewardRound202405,
  columnDefBoardRewardRound202405,
} from "@/lib/tableColumnDef/board/rewardRound202405";
import {
  RowDataBoardRewardCount202405,
  columnDefBoardRewardCount202405,
} from "@/lib/tableColumnDef/board/rewardCount202405";
import {
  RowDataBoardRewardTotal202411,
  columnDefBoardRewardTotal202411,
} from "@/lib/tableColumnDef/board/rewardTotal202411";
import {
  RowDataBoardRewardRound202411,
  columnDefBoardRewardRound202411,
} from "@/lib/tableColumnDef/board/rewardRound202411";
import {
  RowDataBoardRewardCount202411,
  columnDefBoardRewardCount202411,
} from "@/lib/tableColumnDef/board/rewardCount202411";
import {
  RowDataBoardPoint,
  columnDefBoardPoint,
} from "@/lib/tableColumnDef/board/point";
import {
  RowDataBoardStage,
  columnDefBoardStage,
} from "@/lib/tableColumnDef/board/stage";
import {
  RowDataBoardEffect,
  columnDefBoardEffect,
} from "@/lib/tableColumnDef/board/effect";
import {
  RowDataBoardCupid,
  columnDefBoardCupid,
} from "@/lib/tableColumnDef/board/cupid";
import {
  RowDataBoardItem,
  columnDefBoardItem,
} from "@/lib/tableColumnDef/board/item";
