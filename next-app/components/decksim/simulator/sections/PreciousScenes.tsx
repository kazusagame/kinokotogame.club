...
function AddPreciousScenesBlock({
  ...
  const handleClickAddButton = async () => {
    ...
    if (result.id !== null && result.rarity !== null) {
      setValueAtPath({
        path: `petitGirls.preciousScenes.${typeIndex}.${scenesCount + 1}`,
            ...
            <div>
              ...
              <div className="flex gap-5 flex-wrap pl-2 md:pl-4 mt-3">
                {["未選択", "星1", "星2", "星3"].map((rarity) => (
                  <label key={rarity} className="label cursor-pointer flex items-center gap-2">
                    <input
                      type="radio"
                      name="initialRarity"
                      className="radio"
            ...
            <div>
              ...
              <div className="flex gap-5 flex-wrap pl-2 md:pl-4 mt-3">
                {[
                  ...
                  <label key={target} className="label cursor-pointer flex items-center gap-2">
                    <input
                      type="radio"
                      name="effectTarget"
                      className="radio"
