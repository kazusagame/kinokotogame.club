  ...
  return (
    <section className="flex flex-col gap-4 pl-1">
      <div className="flex items-center gap-4">
        <p className="text-lg font-bold">SP応援効果</p>
        <input
          type="text"
          inputMode="numeric"
      ...
      <div className="flex items-center gap-4">
        <p className="text-lg font-bold">捕獲相手</p>
        <select
          id={`${selectId}-1`}
      ...
      <div className="flex flex-wrap items-center gap-4">
        <p className="text-lg font-bold">アタック種別</p>
        <select
          id={`${selectId}-2`}
          className="select select-sm select-bordered"
        ...
        <p className="text-lg font-bold">アタック回数</p>
        <input
          type="text"
          inputMode="numeric"
          className="input input-sm input-bordered max-w-16 md:w-16 text-right"
          value={(data?.eventSpecial?.raidwar?.attackNum ?? 1).toLocaleString(
            "ja-JP",
            {
              style: "decimal",
              useGrouping: true,
      ...
      <div className="flex items-center gap-4">
        <p className="text-lg font-bold">コンボ数</p>
        <select
          id={`${selectId}-3`}
          className="select select-sm select-bordered"
      ...
      <div
        className={`flex items-center gap-4 ${!isSsrEnemy ? "opacity-10" : ""}`}
      >
        ...
        <div className="relative w-fit">
          <input
            ...
            value={(
              data?.eventSpecial?.raidwar?.attackUpBuff ?? 150
            ).toLocaleString("ja-JP", {
              style: "decimal",
              useGrouping: true,
            })}
      ...
      >
        ...
        <div className="relative w-fit">
          <input
            ...
            value={(
              data?.eventSpecial?.raidwar?.totalSkillDamage ?? 0
            ).toLocaleString("ja-JP", {
              style: "decimal",
              useGrouping: true,
            })}
